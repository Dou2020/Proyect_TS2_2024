    ...
    <section id="new-prod-index">
        <div class="container">
            <div class="page-header">
                <h1>Historial<small> de Compras o aceptar Voluntariado</small></h1>
            </div>
            <div class="row">
                <?php
                session_start();
                ...
                $consulta = PublicCRUD::readPublicBuy($_SESSION['idPerson']);
                ...
                if ($totalPublic > 0) {
                    ...
                    echo '<h2>No hay Productos Adquiridos</h2>';
                }
                ?>
            </div>
        </div>
